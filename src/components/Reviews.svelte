...
<div class='flex flex-col gap-10 sm:gap-14 md:gap-24 py-20 flex-1 items-center justify-center bg-violet-200'>
  ...
  <div class='flex flex-col gap-10'>
    <p class="mx-auto text-lg sm:text-xl md:text-2xl font-semibold">Tested by 1,340 Swolediers</p>
    <Stars/>
  </div>
</div>
