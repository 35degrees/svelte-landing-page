<footer class='py-16 sm:py-20 md:py-24 px-4 md:px-8 bg-orange-300 md:bg-orange-400'>
  <div class='max-w-[1200px] mx-auto w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 text-base'>
    <div class='flex flex-col gap-4 md:col-span-2'>
      <h1 class='font-semibold'>
        Swoley <span class='text-indigo-400'>Moley
      </h1>
      <p>&#169;2023 Ltd.</p>
    </div>
    ...
    <div class='flex flex-col gap-4'>
      ...
      <a href=""
      target="_blank"
      class="cursor-pointer hover:text-indigo-400 duration-200">Read the science behind the trainig.</a>
    </div>
    <div class='flex flex-col gap-4'>
      ...
      <i class="fa-brands fa-instagram p-2"></i>Instagram</a>
      <a href=""
      target="_blank"
      class="cursor-pointer hover:text-indigo-400 duration-200">
      <i class="fa-brands fa-facebook p-2"></i>Facebook</a>
      <a href=""
      target="_blank"
      class="cursor-pointer hover:text-indigo-400 duration-200">
      <i class="fa-brands fa-twitter p-2"></i>Twitter</a>
