...
<SectionWrapper id="faqs">
  <div class='flex flex-col gap-10 sm:gap-14 md:gap-24 py-20 flex-1 items-center justify-cent'>
    <div class="flex flex-col gap">
      <p class='opacity-60 text-base sm:text-lg md:text-xl text-center'>For all your questions, qualms and queries.</p>
